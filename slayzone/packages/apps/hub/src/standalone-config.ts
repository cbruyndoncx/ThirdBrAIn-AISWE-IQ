 ...
 * (`env SLAYZONE_HUB_AUTH_SECRET > hub.state.json computerTransportSecret > generate + persist`)
 ...
 * `'slayzone-dev-computer-secret'` dev constant in standalone (that forgeable-token
