/**
 * Bundle the computer into a single self-contained dist/bin.cjs (node target).
 ...
 *
 * The computer installs the SAME agent hooks the desktop app does, from the same
