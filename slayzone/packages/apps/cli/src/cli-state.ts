 ...
 * in here belongs to a hub or a computer, so there is no role to scope by, and the
 ...
 * this module exists to remove. A hub or computer process that seeds `SLAYZONE_ROOT`
