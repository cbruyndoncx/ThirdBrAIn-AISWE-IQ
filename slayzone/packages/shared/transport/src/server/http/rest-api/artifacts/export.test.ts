...
registerArtifactsExportPdfRoute(withExporter, {
  db: h.slayDb,
  notifyRenderer: () => {},
  artifactExport: exporter
})
registerArtifactsExportPngRoute(withExporter, {
  db: h.slayDb,
  notifyRenderer: () => {},
  artifactExport: exporter
})
registerArtifactsExportHtmlRoute(withExporter, {
  db: h.slayDb,
  notifyRenderer: () => {},
  artifactExport: exporter
})
