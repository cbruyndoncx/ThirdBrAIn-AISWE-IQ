/**
 * Minimal typed event emitter used by the computer gateway and dialer. Kept
 * dependency-free on purpose — @slayzone/computer-transport only depends on ws + zod.
 *
 * @module computer/shared/events
 */
