...
assert(
  encodeClaudeProjectDir('/Users/Kalle/dev/projects/slayzone') ===
    '-Users-Kalle-dev-projects-slayzone',
  'plain path encodes'
)
assert(
  encodeClaudeProjectDir('/Users/Kalle/.superset/worktrees/babel') ===
    '-Users-Kalle--superset-worktrees-babel',
