...
const STATUS_MAP: Record<TerminalState, { color: string; pulse: boolean; text: string }> = {
  ...
  // Main agent done, background subagents still working — same hue as `running`
  // (work in flight) but no pulse, so it doesn't read as "needs you".
  background: { color: '#fbbf24', pulse: false, text: 'background work' },
