...
Processes are background tasks managed by the SlayZone app — distinct from PTY terminal sessions (see slay-pty). These include automation computers, background jobs, and other managed child processes.
