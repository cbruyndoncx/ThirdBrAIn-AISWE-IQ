  ...
  return (
    <Dialog
      ...
      onOpenChange={
        autoOpen
          ? () => {
              // Auto-opened onboarding is non-dismissable: swallow Radix's close
              // request so Esc/outside-click can't skip first-run setup. The
              // matching preventDefault handlers are on DialogContent below.
            }
          : handleSkip
      }
    >
