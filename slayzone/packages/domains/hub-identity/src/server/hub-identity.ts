...
// The fingerprint is the hub's pinned computer identity — an expiring cert would
...
export interface HubIdentity {
   ...
   * what computer peers pin, so its derivation must never change.
   */
...
async function generateIdentity(): Promise<IdentityMaterial> {
  ...
  // Backdate notBefore a day to tolerate clock skew across computer machines.
