...
## Goal
`npx @slayzone/hub` / `npx @slayzone/computer` — when a required (runner) or recommended
...
## Runner wiring (`packages/apps/computer/src/bin.ts`)
...
- EDIT `packages/apps/computer/src/bin.ts`
