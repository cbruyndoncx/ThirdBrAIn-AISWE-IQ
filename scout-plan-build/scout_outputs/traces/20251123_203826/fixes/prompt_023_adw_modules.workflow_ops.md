# Fix Broken Python Import (23/93)

## Issue Details
- **File:** `adws/adw_plan_build_test_review.py`
- **Line:** 25
- **Broken import:** `adw_modules.workflow_ops`
- **Import type:** from_import
...
```bash
python -c "import adw_modules.workflow_ops"
```
